...
var defaultOskellyVerifyRules = oskellyVerifyRules{
	Selectors: oskellyVerifySelectorRules{
		...
		AuthRequiredSignals: []string{
			"button.osk-button.osk-button_color-secondary.osk-button_size-m.osk-button_full-width[type='button']",
			"input.osk-input__input[type='text'][autocomplete='email']",
			"input.osk-input__input.osk-input__input_password[type='password'][autocomplete='current-password']",
			"button.osk-button.osk-button_color-primary.osk-button_size-m.osk-button_full-width.osk-auth-login-dialog__button[type='submit']",
		},
	},
	Timeouts: oskellyVerifyTimeoutRules{
